...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/traceability/{orderId}").hasAnyAuthority(Role.EMPLOYEE.name())
                .antMatchers(HttpMethod.GET, "/traceability/").hasAnyAuthority(Role.EMPLOYEE.name())
